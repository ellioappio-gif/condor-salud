    ...
    <div className="space-y-5">
      ...
      <div className="grid lg:grid-cols-2 gap-5">
        ...
        <div className="bg-white border border-border rounded-lg p-5 space-y-4">
          <h3 className="text-xs font-bold tracking-wider text-ink-muted uppercase">Información General</h3>
          {[
            ...
            <div key={f.label} className="flex justify-between items-center py-2 border-b border-border-light last:border-0">
        ...
        {/* Contact */}
        <div className="bg-white border border-border rounded-lg p-5 space-y-4">
          <h3 className="text-xs font-bold tracking-wider text-ink-muted uppercase">Contacto y Ubicación</h3>
          {[
        ...
        <div className="bg-white border border-border rounded-lg p-5">
          <h3 className="text-xs font-bold tracking-wider text-ink-muted uppercase mb-3">Especialidades</h3>
          <div className="flex flex-wrap gap-2">
            {["Cardiología", "Clínica Médica", "Diagnóstico por Imágenes", "Laboratorio", "Kinesiología", "Fonoaudiología"].map((e) => (
        ...
        <div className="bg-white border border-border rounded-lg p-5">
          <h3 className="text-xs font-bold tracking-wider text-ink-muted uppercase mb-3">Financiadores Habilitados</h3>
          <div className="space-y-2">
            {[
              ...
              <div key={f.nombre} className="flex items-center justify-between py-1.5 border-b border-border-light last:border-0">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className={`px-2 py-0.5 text-[9px] font-bold rounded ${f.estado === "Activo" ? "bg-green-50 text-green-700" : "bg-gold-pale text-[#B8860B]"}`}>{f.estado}</span>
                </div>
              </div>
            ))}
          </div>
          <Link href="/dashboard/financiadores" className="text-xs text-celeste-dark font-medium hover:underline mt-3 block">Ver análisis de financiadores →</Link>
        </div>
      </div>
    </div>
  );
